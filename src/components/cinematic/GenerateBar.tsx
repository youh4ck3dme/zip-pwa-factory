...
const DEMO_PROMPTS = [
  {
    id: "barber",
    label: "Barber Shop",
    prompt: "Create a premium PWA landing page for a barber shop with online booking CTA, service showcase, and modern design",
    category: "Business Types"
  },
  {
    id: "salon",
    label: "Beauty Salon",
    prompt: "Create a premium PWA landing page for a beauty salon and spa with appointment booking, treatments list, and elegant styling",
    category: "Business Types"
  },
  {
    id: "restaurant",
    label: "Restaurant",
    prompt: "Create a premium PWA landing page for a fine dining restaurant with menu preview, reservation system, and sophisticated theme",
    category: "Business Types"
  },
  {
    id: "cafe",
    label: "Coffee Shop",
    prompt: "Create a premium PWA landing page for a specialty coffee shop with online ordering, menu highlights, and cozy atmosphere",
    category: "Business Types"
  },
  {
    id: "agency",
    label: "Creative Agency",
    prompt: "Create a premium PWA landing page for a creative digital agency with portfolio showcase, services, and contact CTA",
    category: "Business Types"
  },
  {
    id: "fitness",
    label: "Fitness Studio",
    prompt: "Create a premium PWA landing page for a fitness studio with class schedule, trainer profiles, and membership signup",
    category: "Business Types"
  },
];
